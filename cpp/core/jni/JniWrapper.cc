...
jint JNI_OnLoad(JavaVM* vm, void* reserved) {
  ...
  metricsBuilderConstructor = getMethodIdOrError(
      ...
      metricsBuilderClass,
      "<init>",
      "([J[J[J[J[J[J[J[J[J[JJ[J[J[J[J[J[J[J[J[J[J[J[J[J[J[J[J[J[J[J[J[J[J[J[J[J[J[J[J[J[JLjava/lang/String;Ljava/lang/String;)V");
...
JNIEXPORT jobject JNICALL Java_org_apache_gluten_metrics_IteratorMetricsJniWrapper_nativeFetchMetrics( // NOLINT
  ...
  return env->NewObject(
      ...
      metrics && metrics->timeDetails.has_value() ? env->NewStringUTF(metrics->timeDetails->c_str()) : nullptr);
